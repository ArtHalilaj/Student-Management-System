                               ...
                               perzgjedhjagrupit.map((data, i)=> ( 
                                <tr style={{textAlign:"center",color:"white"}} key={i}> 
                                 <td>{data.Grupi}</td>
                                  ...
                                  <button style={{width:"40%",backgroundColor:"#ff5858",color:"white",fontWeight:"bold",border:"1px solid #ff5858",margin:"0"}} class="butoni2" onClick={ e => handleDelete(data.idG)}>Largohu nga Grupi</button>
                                  </td>
                                   </tr> 
                              )) 
                                    } 
...
export default PerzgjedhjaStudent